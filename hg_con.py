...
def construct_muiH_with_KNN(fts_info,fts_breakfast,fts_lunch,fts_dinner,fts_wg,fts_wljf,fts_library, fts_shopping, K_neigs,split_diff_scale=False, is_probH=True, m_prob=1):
    """
    init multi-scale hypergraph Vertex-Edge matrix from original node feature matrix
    :param X: N_object x feature_number
    :param K_neigs: the number of neighbor expansion
